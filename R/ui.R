...
ui <- function() {
  page_sidebar(
    ...
    layout_columns(
      ...
      value_box(
        title = htmlOutput("narc_cwqg_title"),
        value = htmlOutput("narc_cwqg"),
        showcase = tooltip(
          bsicons::bs_icon("bug-fill"),
          "You must select a chemical"
        )
    ...
    layout_columns(
      fill = FALSE,
      value_box(
        title = p(HTML("P<sub>abs</sub>")),
        value = htmlOutput("pabs"),
        showcase = tooltip(
          bsicons::bs_icon("sun"),
      ...
      value_box(
        title = htmlOutput("photo_cwqg_title"),
        value = htmlOutput("photo_cwqg"),
        showcase = tooltip(
          bsicons::bs_icon("bug"),
          "You must select a chemical and fill in the necessary parameters on the left to run the TUV model"
        )
        ...
        card(
          ...
          p(
            "By default, the app will run the TUV model for 24 hours on the
                  ...
                  determining the narcotic and phototoxic benchmarks."
          ),
          h3("Inputs"),
